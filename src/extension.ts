...
export function activate(context: vscode.ExtensionContext) {
	...
	context.subscriptions.push(vscode.commands.registerCommand('mywiki.toggleReply', (thread: vscode.CommentThread) => {
		thread.canReply = ! thread.canReply;
	}));

	context.subscriptions.push(vscode.commands.registerCommand('mywiki.toggleCommentReply', (reply: vscode.CommentReply) => {
